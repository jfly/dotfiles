...
# Copied from https://raw.githubusercontent.com/pahud/gitpod-workspace/main/utils/refresh_credentials.sh
# See https://github.com/aws/aws-cdk/issues/5455 for details. Urg.
